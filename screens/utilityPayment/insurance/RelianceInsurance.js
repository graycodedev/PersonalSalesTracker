...
export class RelianceInsurance extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      policyNumberError: "",
  ...
  GetDetails = async () => {
    ...
    if (response != undefined) {
      if (response.data.Code == 200) {
        this.props.navigation.navigate("Reliance Payment", {
...
export class RelianceInsurancePayment extends React.Component {
  constructor(props) {
    super(props);
  ...
  confirmPayment = async () => {
    ...
    var confirmationData = [
      ...
      },
      {
        label: "Product Name :",
        value:
          this.state.productName.split(" ")[0] +
          " " +
          this.state.productName.split(" ")[1] +
          " " +
          this.state.productName.split(" ")[2],
      },
      {
        label: "Amount:",
    ...
    var response = await (await request())
      .post(api.Reliance.MakePayment, data)
      .catch(function(error) {
        ToastMessage.Short("Error Ocurred Contact Support");
      });
    if (response != undefined) {
      if (response.data.Code == 200) {
        ...
        this.props.navigation.navigate("Reliance Success", {
...
export class RelianceInsuranceSuccessful extends React.Component {
  constructor(props) {
    super(props);
  }
  render() {
