...
export class UnionLifeInsurance extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      policyNumberError: "",
  ...
  GetDetails = async () => {
    ...
    if (response != undefined) {
      if (response.data.Code == 200) {
        this.props.navigation.navigate("Union Life Payment", {
...
export class UnionLifeInsurancePayment extends React.Component {
  constructor(props) {
    super(props);
  ...
  confirmPayment = async () => {
    ...
    if (response != undefined) {
      if (response.data.Code == 200) {
        ...
        this.props.navigation.navigate("Union Life Success", {
...
export class UnionLifeInsuranceSuccessful extends React.Component {
  constructor(props) {
    super(props);
  }
  render() {
