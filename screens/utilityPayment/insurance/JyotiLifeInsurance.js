...
export class JyotiLifeInsurance extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      policyNumberError: "",
  ...
  GetDetails = async () => {
    ...
    if (response != undefined) {
      if (response.data.Code == 200) {
        ...
        this.props.navigation.navigate("Jyoti Life Payment", {
...
export class JyotiLifeInsurancePayment extends React.Component {
  constructor(props) {
    super(props);
  ...
  confirmPayment = async () => {
    ...
    if (response != undefined) {
      if (response.data.Code == 200) {
        ...
        this.props.navigation.navigate("Jyoti Life Success", {
...
export class JyotiLifeInsuranceSuccessful extends React.Component {
  constructor(props) {
    super(props);
  }
  render() {
