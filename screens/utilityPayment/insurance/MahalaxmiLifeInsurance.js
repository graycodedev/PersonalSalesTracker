...
export class MahalaxmiLifeInsurance extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      policyNumberError: "",
  ...
  GetDetails = async () => {
    ...
    if (response != undefined) {
      if (response.data.Code == 200) {
        this.props.navigation.navigate("Mahalaxmi Life Payment", {
...
export class MahalaxmiLifeInsurancePayment extends React.Component {
  constructor(props) {
    super(props);
  ...
  confirmPayment = async () => {
    ...
    if (response != undefined) {
      if (response.data.Code == 200) {
        ...
        this.props.navigation.navigate("Mahalaxmi Life Success", {
...
export class MahalaxmiLifeInsuranceSuccessful extends React.Component {
  constructor(props) {
    super(props);
  }
  render() {
