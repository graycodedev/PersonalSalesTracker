...
export class PrimeLifeInsurance extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      policyNumberError: "",
  ...
  GetDetails = async () => {
    ...
    if (response != undefined) {
      if (response.data.Code == 200) {
        this.props.navigation.navigate("Prime Life Payment", {
...
export class PrimeLifeInsurancePayment extends React.Component {
  constructor(props) {
    super(props);
  ...
  confirmPayment = async () => {
    ...
    var response = await (await request())
      .post(api.PrimeLife.MakePayment, data)
      .catch(function(error) {
        ToastMessage.Short("Error Ocurred Contact Support");
      });
    if (response != undefined) {
      if (response.data.Code == 200) {
        ...
        this.props.navigation.navigate("Prime Life Success", {
...
export class PrimeLifeInsuranceSuccessful extends React.Component {
  constructor(props) {
    super(props);
  }
  render() {
