...
export class SimTV extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      customerid: "",
  ...
  GetDetails = async () => {
    ...
    if (response != undefined) {
      if (response.data.Code == 200) {
        this.props.navigation.navigate("SimTV Payment", {
...
export class SimTVPayment extends React.Component {
  constructor(props) {
    super(props);
    ...
    this.state = {
      ...
      code: "",
      dueAmount: data.data.due_amount,
      uniqueid: null,
      showpin: false,
      isLoading: false,
  ...
  confirmpayment = async () => {
    ...
    if (response != undefined) {
      if (response.data.Code == 200) {
        this.props.navigation.navigate("SimTV Success", {
          ...
          {this.state.showpin == false ? (
            <View style={{zIndex:99}}>
              ...
              <View style={styles.detailcontainer}>
                ...
                <View style={styles.rowdata}>
                  <Text style={styles.variablename}>Due Amount:</Text>
                  <Text style={styles.value}>{this.state.dueAmount}</Text>
                </View>
              </View>
...
export class SimTVSuccessful extends React.Component {
  constructor(props) {
    super(props);
  }
  render() {
