    ...
    <View style={[styles.container]}>
                ...
                >
                  <View>
                    <Text style={AppStyles.Text.BoldTitle}>
                      {new Date(odometer.StartDate).toLocaleDateString(
                        "en-US",
                    ...
                    <Text style={styles.tripInfo}>
                      Start Odometer: {odometer.StartOdometer}
                    </Text>
                    <View
                      style={{
                        flexDirection: "row",
                    ...
                    >
                      <Text style={styles.tripInfo}>
                        End Odometer: {odometer?.EndOdometer || ""}
                      </Text>
      ...
      {isClicked && (
        ...
        >
          ...
          >
            <Animated.View
              style={[styles.overlay, { flex: 1, transform: [{ translateY }] }]}
            >
